...
import { User, Building, Bell, Shield, CreditCard, Users, Key, Camera, Save, Trash2 } from "lucide-react"
  ...
  return (
    <div className="space-y-6" data-dashboard>
      ...
      <div className="animate-slide-up">
        ...
        <p className="text-muted mt-1">Manage your account and workspace preferences</p>
      </div>
        ...
        <TabsContent value="company" className="space-y-6">
          <Card className="animate-slide-up">
            <CardHeader>
              ...
              <CardDescription>Manage your company details and workspace settings</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted">Receive push notifications on your devices</p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted">Show notifications on your desktop</p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted">Receive updates about new features and promotions</p>
                  </div>
                  <Switch
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-muted">$29/month • Billed monthly</p>
                </div>
        ...
        <TabsContent value="team" className="space-y-6">
          <Card className="animate-slide-up">
            <CardHeader>
              ...
              <CardDescription>Manage team permissions and workspace settings</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted">Team members can send invitations to new users</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted">New team members need admin approval before joining</p>
                  </div>
                  <Switch />
                </div>
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted">Team members can share files with people outside the workspace</p>
                  </div>
                  <Switch defaultChecked />
                </div>
              </div>
